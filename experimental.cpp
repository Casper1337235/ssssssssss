...
//	record_data->pose_paramaters = entity->get_pose_paramaters2();
...
//	entity->get_pose_paramaters2() = record_data->pose_paramaters;
...
void C_LagCompensation::predict_player(IClientEntity* entity, C_Tick_Record* current_record, C_Tick_Record* next_record) const
{
	...
	auto simulation_tick_delta = std_clamp(TIME_TO_TICKS(simulation_time_delta), 1, 16);
