...
public:
	...
	CColorSelector skeleton_terrorist;
	CColorSelector skeleton_counterterrorist;
	...
	CColorSelector real_yaw_arrow;
	CColorSelector fake_yaw_arrow;
...
public:
	...
	CKeyBind manual_desync_left;
	CKeyBind manual_desync_right;
