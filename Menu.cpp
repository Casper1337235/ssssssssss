...
#pragma region Aimbot
	...
	resolver.AddItem("Mirror Anti Desync");
	resolver.AddItem("Mirror Anti Fake Angles");
	resolver.AddItem("Fatality.win");
//	resolver.AddItem("experimental");
	...
	*/
	...
	lag_pred.AddItem("Low");
	lag_pred.AddItem("Medium");
	lag_pred.AddItem("High");
	...
	head_walking.SetFileId("bodyaim_head_walking");
	AimbotGroup.PlaceLabledControl(4, "Prefer Head If Walking", this, &head_walking);
	...
	ignore_limbs.SetFileId("bodyaim_ifmoving");
	AimbotGroup.PlaceLabledControl(4, "Ignore Limbs If Moving", this, &ignore_limbs);
...
#pragma region Options
	...
	filter_antiaim.SetFileId("ftr_antiaim");
	OptionsGroup.PlaceLabledControl(2, "Anti Aim", this, &filter_antiaim);
...
//	OptionsGroup.PlaceLabledControl(4, "Bullet Beam", this, &bulletbeam);
	...
	zoom.SetFileId("otr_zoomkey");
	OptionsGroup.PlaceLabledControl(4, "Zoom", this, &zoom);
	...
	visible_chams_type.AddItem("dev_Glow");
	...
	invisible_chams_type.AddItem("dev_Glow");
	invisible_chams_type.AddItem("Fbi");
	invisible_chams_type.AddItem("Fishnet"); // fish niggas
...
//	ChamsGroup.PlaceLabledControl(1, "Server Angle Ghost", this, &fakelag_ghost);
	...
	localmaterial.AddItem("dev_Glow");
	localmaterial.AddItem("Fbi");
	localmaterial.AddItem("Fishnet");
	...
	HandCHAMS.AddItem("dev_Glow");
	HandCHAMS.AddItem("Fbi");
	HandCHAMS.AddItem("Fishnet");
	...
	GunCHAMS.AddItem("dev_Glow");
	GunCHAMS.AddItem("Fbi");
	GunCHAMS.AddItem("Fishnet");
	...
	SleeveChams.AddItem("dev_Glow");
	SleeveChams.AddItem("Fbi");
	SleeveChams.AddItem("Fishnet");
	...
	*/
	...
	// life is pointless. Doing mirror just to pass the time
...
#pragma region Other
	...
	FakelagStand.SetBoundaries(1, 16);
	...
	FakelagMove.SetBoundaries(1, 16);
	...
	Fakelagjump.SetBoundaries(1, 16);
	...
	fakelag_unlock.SetFileId("fakelag_unlockmax");
	AntiAimGroup.PlaceLabledControl(2, "Unlock Max Fakelag", this, &fakelag_unlock);

	fakelag_fd.SetFileId("fakelag_fakducking");
	fakelag_fd.SetBoundaries(12.f, 16.f);
	fakelag_fd.setvalue(14.f);
	AntiAimGroup.PlaceLabledControl(2, "Fakelag When Fake Ducking", this, &fakelag_fd);
	//	auto_fakelag.SetFileId("fakelag_auto");
	//	AntiAimGroup.PlaceLabledControl(2, "Dynamic Fakelag", this, &auto_fakelag);

	lag_model.SetFileId("fakelag_show_lagmodel");
	AntiAimGroup.PlaceLabledControl(2, "Show Lag Model", this, &lag_model);
	...
	desync_type_stand.AddItem("Manual Static");
	desync_type_stand.AddItem("Fake Angle (random)");
	...
	desync_type_move.AddItem("Manual Static");
	desync_type_move.AddItem("Fake Angle (random)");
	...
	manual_desync_left.SetFileId("desync_manual_left");
	AntiAimGroup.PlaceLabledControl(4, "Manual Desync Left", this, &manual_desync_left);

	manual_desync_right.SetFileId("desync_manual_right");
	AntiAimGroup.PlaceLabledControl(4, "Manual Desync Right", this, &manual_desync_right);
}

/*
		"i hope one day, you are re-united with the one you cherish"
	- Aira
*/
...
#pragma region Visual Colors
	...
	skeleton_terrorist.SetFileId(XorStr("player_skeleton_color"));
	ColorsGroup.PlaceLabledControl(1, XorStr("Skeleton Terrorist"), this, &skeleton_terrorist);

	skeleton_counterterrorist.SetFileId(XorStr("player_skeletonteam_color"));
	ColorsGroup.PlaceLabledControl(1, XorStr("Skeleton Counter-Terrorist"), this, &skeleton_counterterrorist);
...
//	ColorsGroup.PlaceLabledControl(2, XorStr("Bullet Impact"), this, &bullet_tracer);
	...
	real_yaw_arrow.SetFileId("player_real_yaw_arrow");
	ColorsGroup.PlaceLabledControl(2, XorStr("Real Anti Aim Arrow"), this, &real_yaw_arrow); // because people wanted this.

	fake_yaw_arrow.SetFileId("player_fake_yaw_arrow");
	ColorsGroup.PlaceLabledControl(2, XorStr("Fake Anti Aim Arrow"), this, &fake_yaw_arrow);
	...
	OtherOptions2.PlaceLabledControl(0, XorStr("Background Shade"), this, &owo_slider);
}
